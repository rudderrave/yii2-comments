...
class Comments extends \yii\base\Module
{
     ...
     * @var string
     */
    public $controllerNamespace = 'ravesoft\comments\controllers';
     ...
     * 
     * Note! `ravesoft\comments\components\Akismet` component must be configured:
     * 
     * ~~~
     * 'components' => [
     *     'akismet' => [
     *         'class' => 'ravesoft\comments\components\Akismet',
     *         'apiKey' => '*******',
     *     ],
     * ]
     * ~~~
    ...
    public function registerTranslations()
    {
        Yii::$app->i18n->translations['yii2-comments/*'] = [
            ...
            'basePath' => '@vendor/ravesoft/yii2-comments/messages',
            'fileMap' => [
